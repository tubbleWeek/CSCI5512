...
def resample(particles, weights, num_particles):
    ...
    # If total weight is zero, return a uniform sample.
    if total_weight == 0:
...
def particle_filter(num_particles, evidence):
    """
    Run particle filtering on the umbrella network.
